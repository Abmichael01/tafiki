...
const Register: React.FC = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col gap-[40px]">
      { !success &&  <div className="space-y-[20px] w-full">
        <div className="">
      ...
      <h3 className=" italic text-[16px] text-[#636C67] justify-self-end hidden md:block">
        <span className="font-[700]">Partner:</span> Join as a Partner (Distributor) to access exclusive partner shops, purchase product packages, and earn monthly profit shares through our distribution program. Perfect for business-oriented users.
      </h3>
    </div>
  );
};
