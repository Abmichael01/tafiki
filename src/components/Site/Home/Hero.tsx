  ...
  return (
    <div className="relative flex items-center justify-between w-full gap-[30px] min-h-[700px]">
      ...
      >
        ...
        >
          <motion.p variants={fadeInUp} className="text-[#5D5D5D] text-sm mb-4">
            With over:
          </motion.p>
          <div className="grid grid-cols-4 gap-4">
            {statistics.map((stat, index) => (
              ...
              >
                <h3 className="text-[19px] sm:text-[24px] font-satoshi-bold font-[700] text-[#86BF4C] ">
                  {stat.number}
                </h3>
                <p className="text-[#5D5D5D] text-xs font-[500]">
                  {stat.label}
                </p>
              </motion.div>
            ))}
